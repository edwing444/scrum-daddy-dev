...
const ManagerTablePendingReq = ({ fetchWFHRequests, requestId }) => {
  ...
  const [rejectSelectedEntries, setRejectSelectedEntries] = React.useState({}); //reject
  ...
  const handleChangePage = (event, newPage) => {
    ...
    if(currentPath.includes("my")){
      ...
      navigate('/managerRequestsPage', { replace: true });
    }
  };
                ...
                <StyledTableRow>
                  <StyledTableCell align="right">
                    <IconButton
                      ...
                      size="small"
                      onClick={() => handleToggleRow(request.request_id)}
                    >
                      {openRow === request.request_id? (
                        <KeyboardArrowUpIcon />
                      ) : (
                  ...
                  <StyledTableCell align="left">
                    {employeeData[request.requester_id] || request.requester_id}
                  </StyledTableCell>
                  <StyledTableCell align="left">
                    {employeeData[request.reporting_manager] || request.reporting_manager}
                  </StyledTableCell>
                  <StyledTableCell align="left">
                  ...
                  >
                    <Box margin={1}>
                      <Typography style={{ fontFamily: 'Montserrat, sans-serif' }}>
                        ...
                        {/* Display message and count from fetcHWFHCount of this specific entry*/}
                      </Typography>
...
export default ManagerTablePendingReq;
